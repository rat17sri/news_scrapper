...
class SendingToPostgres(ExtractedInformationStorage):
    ...
    try:
        ...
        cursor.execute(cmmd,(ExtractedInformationStorage.item['url'],ExtractedInformationStorage.item['date_download'],ExtractedInformationStorage.item['url'],ExtractedInformationStorage.item['title'],ExtractedInformationStorage.item['title_page'],ExtractedInformationStorage.item['authors'],ExtractedInformationStorage.item['image_url'],ExtractedInformationStorage.item['date_publish']))
        conn.commit()
        cursor.close()
